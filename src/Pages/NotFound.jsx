...
const NotFound = () => {
    return (
        <div className='pl-2.5 pr-2.5  w-full h-lvh flex flex-col justify-center items-center'>
            ...
            <p className='text-[18px]'> The page you’re looking for doesn’t exist. No worries! You can go back to The Home page.</p>
            <img src={assets.notfound} alt='not found' className='min-w-60 max-w-[500px] w-full' />
